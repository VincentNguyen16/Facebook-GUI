...
/*
   Function to display a specific friend's posts.
   This function traverses the friends' list of the user and displays their posts.
*/
void display_friend_posts(user_t *user, const char *friend_name);

/*
   Function to log in a user by validating their username and password.
   Returns a pointer to the logged-in user, or NULL if login fails.
*/
